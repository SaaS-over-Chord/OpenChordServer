...
/*modified*/ public abstract void dqdhtProcess(Serializable s, ID askingNodeId, ID limitNodeId ) throws CommunicationException ;        
	/**
    ...
    public Node dqdht_process(Serializable s, NodeImpl localNode, Node get) {
