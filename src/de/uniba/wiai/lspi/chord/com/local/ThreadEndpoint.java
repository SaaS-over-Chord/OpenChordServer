...
public final class ThreadEndpoint extends Endpoint {
	 ...
	 */
        ...
        public void dqdhtProcess(Serializable s, ID askingNodeId, ID limitNodeId)
            ...
            this.checkIfCrashed();
            this.waitFor(Endpoint.LISTENING);
            this.notifyInvocationListeners(InvocationListener.DQDHT_PROCESS);
            this.node.dqdhtProcess(s, askingNodeId, limitNodeId);
            this.notifyInvocationListenersFinished(InvocationListener.DQDHT_PROCESS);
       }
