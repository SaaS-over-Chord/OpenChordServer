...
import de.uniba.wiai.lspi.util.console.SocketThread;
...
public class Main {
	...
	public static void main(String[] args) throws Throwable {
		...
		commandMapping.put(ChangeProtocol.COMMAND_NAME, ChangeProtocol.class
				.getName());
/* modified*/		commandMapping.put(DqDht.COMMAND_NAME, DqDht.class
				.getName());
		/*
        ...
        SocketThread s = SocketThread.getConsole("oc", factory,
				new MemoryOutputStream());
				s.start();
