...
/**
 * <p>
 * {@link Command} to perform DQDHT over the chord ring.
 * </p>
 ...
 * @version 1.0.5
 */
public class DqDht extends Command {

	/**
	 * The name of this {@link Command}.
	 */
    public static final String COMMAND_NAME = "dqdht";
     ...
     * @param toCommand1
     * @param out1 */
    public DqDht(Object[] toCommand1, java.io.PrintStream out1) {
    ...
    public void exec() throws ConsoleException {
        ...
        //this.out.println("testing");
        chord.dqdhtSubmit(10, key.toLowerCase());
